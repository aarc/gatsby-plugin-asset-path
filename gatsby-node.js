...
var onPostBuild = exports.onPostBuild = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(_ref3, _ref4) {
    var pathPrefix = _ref3.pathPrefix;
    var _ref4$additionalFiles = _ref4.additionalFiles,
        additionalFiles = _ref4$additionalFiles === undefined ? [] : _ref4$additionalFiles,
        _ref4$directories = _ref4.directories,
        directories = _ref4$directories === undefined ? ["static", "icons", "page-data"] : _ref4$directories,
        _ref4$fileTypes = _ref4.fileTypes,
        fileTypes = _ref4$fileTypes === undefined ? ["js", "css"] : _ref4$fileTypes;
    var publicFolder, assetFolder, move, filesExtensions, filesRegex, filterFilesIn, filesInPublicFolder, thingsToMove;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            move = function move(fileOrFolder) {
            ...
            filesRegex = RegExp(".*.(" + filesExtensions + ")$");
            ...
            thingsToMove = directories.concat(filesInPublicFolder).concat(additionalFiles);

            // Move files and directories

            _context.next = 10;
            return _promise2.default.all(thingsToMove.map(move));
